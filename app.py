import os, re, subprocess, tempfile, json, zipfile, urllib.request, stat
...
@st.cache_resource
def ensure_deno():
    """Download a portable Deno binary so yt-dlp can solve YouTube's JS
    signature challenge. Cached for the life of the app instance."""
...
if st.button("Find & Cut Clips", type="primary"):
    ...
    with st.status("Working on it...", expanded=True) as status:
        ...
        cmd = ["yt-dlp", "--ffmpeg-location", FFMPEG]
        if deno_path:
